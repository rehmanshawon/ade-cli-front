        ...
        >
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive(
                  "/user-setting/user-feature-module"
                )}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/user-setting/user-feature-module">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">User Feature Module By Role</span>
                </NavLink>
              </li>
              <li
                className={`menu-item ${getMenuItemActive(
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              >
                <NavLink
                  className="menu-link"
                  to="/admin-setting/slider-setting"
                >
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
                  <span className="menu-text">Slider Setting</span>
                </NavLink>
              </li>
              {/*end::1 Level*/}
            </ul>
        ...
        >
          ...
          <div className="menu-submenu ">
            ...
            <ul className="menu-subnav">
              ...
              <li
                className={`menu-item ${getMenuItemActive(
                  "/delivery-process/paymentgateway"
                )}`}
                aria-haspopup="true"
              >
                <NavLink className="menu-link" to="/delivery-process/paymentgateway">
                  <i className="menu-bullet menu-bullet-dot">
                    <span />
                  </i>
